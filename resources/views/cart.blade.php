                        ...
                        <!-- @foreach($product as $key => $product)
                            ...
                            <li class="header-cart-item flex-w flex-t m-b-20">
                                ...
                                <div class="header-cart-item-txt-2">
                                    <a href="#" class="limit-text-2 header-cart-item-name m-b-5 hov-cl1 trans-04 ">
                                        {{$product->name}}
                                    </a>
                                    <?php if(count($coupons) > 0) { ?>
                                        @foreach ($coupons as $key => $coupon)
                                            ...
                                            @endif
                                        @endforeach
                                        <div class="product-price fs-15 p-b-30">
                                            <span style="color:#888; font-size: 15px">{{ $price }}₫</span>
