...
<body>
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="/register-checkout" method="POST">
                {{csrf_field()}}
                <div class="logo">
        ...
        <div class="form-container sign-in-container">
            <form action="/login-checkout-store" method="POST" class="signin-form">
                {{csrf_field()}}
                <div class="logo">
                    <a href="#"><img src="/template/images/icons/image-logo-icon.png" alt="logo"></a>
                </div>
    ...
    <footer>
        <p>
            CẢM ƠN ĐÃ TIN TƯỞNG SPORTSWEAR SHOP! HY VỌNG BẠN SẼ TRẢI NGHIỆM MUA HÀNG TỐT NHẤT 
